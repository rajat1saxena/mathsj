...
class Create_Basic_Info_Table {
	...
	public function up()
	{
		Schema::create('basicinfo',function($table){
		...
		DB::table('basicinfo')->insert(
			array(
				'phone' => '+91-9898989898',
				'email' => 'contact@mathsjee.in',
				'owner' => 'Mr Rajat Saxena',
				'fullinfo' => 'Contrary to popular belief, Lorem Ipsum is not simply random text.
